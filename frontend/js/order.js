document.addEventListener("DOMContentLoaded", () => {
    ...
    // 🆕 Gắn sự kiện mở modal khi bấm "Thay đổi"
...
function updateOrderSummary(products) {
    ...
    // Nếu tổng giá trị sản phẩm > 500.000 thì miễn phí ship
    ...
    const shippingText = shippingFee === 0 ? "Quốc tế (Miễn phí)" : `Quốc tế (đ${shippingFee.toLocaleString()})`;
    document.getElementById("shipping-method").textContent = shippingText;
}
